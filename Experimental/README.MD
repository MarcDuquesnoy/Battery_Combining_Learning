...
Setup
========================================================
We recommand you to get a version of RStudio greater than "1.2".


Code
========================================================

Regarding the available dataset inside **./data**, you can
 directly use the code for the corresponding R file.
